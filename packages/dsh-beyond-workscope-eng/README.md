...
pnpm install
pnpm --filter @linxin666/dsh-beyond-workscope-eng build
...
```sh
pnpm --filter @linxin666/dsh-beyond-workscope-eng typecheck   # 类型检查
pnpm --filter @linxin666/dsh-beyond-workscope-eng test        # 单测（grants/perceive）
pnpm --filter @linxin666/dsh-beyond-workscope-eng build       # lib + client bundle
```
